...
public class ProjectTest {
    ...
    public void testAgregarTarea() {
        Tarea tarea = new Tarea("Task 1", startDate, endDate, "Task Description");
    ...
    public void testGetSprintsPlanificacion() {
        ...
        List<Tarea> tareas = new ArrayList<>();
        tareas.add(new Tarea("Task 1", startDate, endDate, "Task Description"));
        tareas.add(new Tarea("Task 2", startDate, endDate, "Task Description"));
